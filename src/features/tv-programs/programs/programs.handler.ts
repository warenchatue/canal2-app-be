...
export const ORDER_CREATED_EVENT = 'tvProgram.create';

@Injectable()
export class TvProgramHandler {
  private readonly logger: Logger = new Logger(TvProgramHandler.name);
  ...
  async handleTvProgramCreated(data) {
    try {
